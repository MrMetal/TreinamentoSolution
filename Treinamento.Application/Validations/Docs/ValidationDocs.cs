namespace Treinamento.Application.Validations.Docs;
...
public class DigitoVerificador(string numero)
{
    ...
    {
        return !(numero.Length > 0) ? "" : GetDigitSum();
    }
    ...
    private string GetDigitSum()
    {
        ...
        return _substituicoes.TryGetValue(resultado, out var substituicoe) ? substituicoe : resultado.ToString();
    }
}
